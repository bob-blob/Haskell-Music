...
/* package MusicComposer-0.1.0.0 */
#define VERSION_MusicComposer "0.1.0.0"
#define MIN_VERSION_MusicComposer(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)

/* package ALUT-2.4.0.2 */
#define VERSION_ALUT "2.4.0.2"
...
/* package codeworld-api-0.2.5 */
#define VERSION_codeworld_api "0.2.5"
...
#define CURRENT_COMPONENT_ID "MusicComposer-0.1.0.0"

#define CURRENT_PACKAGE_KEY "MusicComposer-0.1.0.0"
